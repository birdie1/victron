...
class Smartsolar:
    ...
    def __init__(self, config):
        ...
        if 'smartsolar' in self.config['collections']:
            for collection in self.config['collections']['smartsolar'].keys():
                self.reset_collection(collection)

    def reset_collection(self, collection_name):
        collection = {}
        for item in self.config['collections']['smartsolar'][collection_name]:
